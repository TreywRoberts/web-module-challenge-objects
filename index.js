...
console.log(createMenuItem('taco',11,'lunch'))
console.log(createMenuItem('salad',9,'lunch'))
console.log(createMenuItem('filet',29,'lunch'))
...
function discount(occupation) {
  if(occupation === "teacher" || occupation === "student") {
    newPrice = burger.price - (burger.price * .25)
    return console.log(newPrice)
  } else if(occupation === "public") {
    NewPrice = burger.price - (burger.price * .10)
    return console.log(NewPrice)
  }  else{
    return console.log("No sale")
  }
}
discount("teacher")
...
reviews.push({name:"Trey", rating: 5, feedback: "This places rocks!"},)
console.log(reviews)
